...
/**
 *This class is a driver class of LuxuryCruiseShip program.
 *This class will add CruiseShips' information to build a graph
 *
 * @author Seth
 */
public class LuxuryCruiseTestClass {
    ...
    {   System.out.println("------ LUXURY CRUISES -----");
        ...
        buildGraph(centre);
        //testing
        centre.getPossibleJourneys("Auckland", new GregorianCalendar(2020, Calendar.JUNE,1), "Vanuatu");
